...
I used the default **bootstrap resampling to cross validate** the data and avoid overfit besides K–fold Cross Validation.
...
We can see that the model has an accuracy of ~93.8% and Kappa value of ~0.92 wich is considered pretty good.

Since the model uses resampling, we can take a look of how it estimates the error in unseen data, through the Out Of Bag (OOB) estimate of error, in this case **5.02%**
