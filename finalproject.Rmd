...
Since the model uses resampling, we can take a look of how it **estimates out of sample error** in unseen data, through the Out Of Bag (OOB) estimate of error, in this case **5.02%**
